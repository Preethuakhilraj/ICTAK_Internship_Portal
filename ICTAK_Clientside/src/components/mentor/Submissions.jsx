...
const Submissions = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setNewMaterial({ topic: '', referenceMaterial: '', postedDate: '', url: '' });
    } catch (error) {
              ...
              <AccordionDetails>
                <form onSubmit={handleSubmit}>
                  <FormControl fullWidth margin="normal" variant="filled">
                    <InputLabel id="projecttopic-label">Stack</InputLabel>
                    <Select
                      required
                      labelId="projecttopic-label"
                      id="projecttopic"
                      name="projecttopic"
                      value={newMaterial.projecttopic}
                      onChange={handleChange}
                    >
                      {projecttopic.map((stackItem) => (
  ...
  {filteredMaterials.map((material) => (
    <ListItem key={material._id} disablePadding>
      <ListItemButton>
        <ListItemText
          primary={material.referenceMaterial}
          secondary={`Posted on: ${material.postedDate}`}
        />
